...
public class CmPutResponse implements WriteResponse {
 ...
 private Collection<CmObject> cmObjects;
    ...
    public CmPutResponse(ResponseType responseType, ErrorResponseType errorResponseType, MoObjects moObjects, int httpCode) {
    ...
    public CmPutResponse(ResponseType responseType, ErrorResponseType errorResponseType, Collection<CmObject> cmObjects, int httpCode) {
        this.responseType = responseType;
        this.errorResponseType = errorResponseType;
